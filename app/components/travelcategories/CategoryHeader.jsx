...
export default function CategoryHeader() {
  return (
    <div className="w-full flex flex-col md:flex-row md:items-end justify-between text-black gap-4 px-2">
      <div className="flex flex-col gap-2 text-center md:text-left">
        {/* Tiny Orange Tag */}
        <div className="flex items-center justify-center md:justify-start gap-1.5 text-black font-bold text-xs uppercase tracking-widest">
        ...
        <p className="text-black/60 text-xs sm:text-sm font-medium tracking-wide">
      ...
      <div className="flex items-center justify-center pt-1 md:pt-0">
        <Link 
          href="/categories" 
          className="group flex items-center gap-2 text-xs sm:text-sm font-bold tracking-wide hover:text-orange-400 transition-colors duration-200"
        >
