    ...
    >
      ...
      <div className="relative w-full max-w-4xl flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 z-10 mt-[-20px]">
        ...
        >
          ...
          <button type="button" className="flex items-center justify-between bg-sky-700 hover:bg-sky-700 text-white font-bold py-3 pl-6 pr-2 rounded-full w-full max-w-[240px] shadow-lg shadow-sky-700/20 transition-all duration-300 group">
          ...
          <a 
            ...
            className="flex items-center gap-2 text-white/90 hover:text-sky-700 font-semibold text-sm mt-6 transition-colors duration-200"
          >
            <span className="text-xs text-sky-700">📞</span>
