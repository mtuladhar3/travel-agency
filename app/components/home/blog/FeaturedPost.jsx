...
export default function FeaturedPost() {
  return (
    <motion.div 
      ...
      className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 lg:gap-8 bg-white rounded-3xl overflow-hidden p-4 md:p-6 lg:p-8 items-stretch shadow-[0_8px_24px_rgba(0,0,0,0.08)]"
    >
      {/* Optimized Image Container */}
      <div className="md:col-span-6 order-1 relative aspect-[4/3] w-full rounded-3xl overflow-hidden group">
        <Image 
          src="/images/timed-cards-1.jpg" 
          alt="How to travel in style"
          fill
          priority
      ...
      <div className="md:col-span-6 order-2 flex flex-col justify-center">
        <div className="mb-4">
          <PostBadge>Travel Tips</PostBadge>
        </div>
        ...
        <p className="text-gray-500 text-sm leading-relaxed mb-6">
          Discover affordable ways to enjoy luxury travel – from stylish stays to secret booking hacks...
        </p>
